...
for i in range(TRACKS):
    ...
    np.savetxt(filenameTrackNo(i+1, DP, ".txt", GENRE, "trackPeaks -right"), trackPeaks)


# FILE I/O: export findings
pd.DataFrame(df).to_csv(GENRE + "loudness features -right.csv") #please input the relevant array and desired file name
